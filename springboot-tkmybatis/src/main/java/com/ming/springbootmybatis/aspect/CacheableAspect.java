//package com.ming.springbootmybatis.aspect;
//
//import com.ming.springbootmybatis.annotation.MyCacheable;
...
///**
// * redis缓存处理
// * 不适用于内部方法调用(this) 或者private
// *
// * @author zhangming
// * @version 1.0
// * @date 2019/7/15 8:48 PM
// */
//@Component
//@Aspect
...
//
//    @Pointcut("@annotation(com.ming.springbootmybatis.annotation.MyCacheable)")
...
//    }
//
//    private int getExpireTime(MyCacheable annotation) {
